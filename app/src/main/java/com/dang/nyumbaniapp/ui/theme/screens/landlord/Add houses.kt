package com.dang.nyumbaniapp.ui.theme.screens.landlord
...
import com.dang.nyumbaniapp.data.productviewmodel
import com.dang.nyumbaniapp.navigation.ROUTE_VIEW_HOUSE


@Composable
fun Addhouse(navController: NavHostController) {
    Column(modifier = Modifier.fillMaxSize(),
        ...
        Button(onClick = {
            ...
            productRepository.saveProduct(productName.text.trim(),productQuantity.text.trim(),
                productPrice.text)
            navController.navigate(ROUTE_VIEW_HOUSE)
...
@Composable
fun Addpr() {
    Addhouse(rememberNavController())
